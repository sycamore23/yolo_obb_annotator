...
class ImageCanvas(QWidget):
    ...
    def wheelEvent(self, event):
        ...
        if old_scale != self.scale_factor and img_pos:
            ...
            self.offset.setX(event.pos().x() - rel_x * self.scale_factor)
            self.offset.setY(event.pos().y() - rel_y * self.scale_factor)
    ...
    def finish_annotation(self):
        ...
        if self.current_bbox:
            ...
            # 获取当前类别
            current_class = self.classes[0] if self.classes else None
            ...
            annotation = AnnotationItem(
                ...
                class_name=current_class.name if current_class else "object",
